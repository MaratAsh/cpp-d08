...
void Span::addSequence(std::vector<unsigned int>::iterator begin,
					   std::vector<unsigned int>::iterator end) {
	for (std::vector<unsigned int>::iterator curr = begin; curr != end; curr++)
	{
		addNumber(*curr);
	}
}
...
Span::SpanException::SpanException(std::string msg): _msg(msg) {}
